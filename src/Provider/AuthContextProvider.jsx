...
const AuthContextProvider = ({ children }) => {
  ...
  const authInfo = { registerUser, user, logOut, loginUser , isLogged, setIsLogged ,toastPush,isAdmin, isStudent, isInstructor,loading , adminStateLoading,userData, setUserData}  ;
  return (
